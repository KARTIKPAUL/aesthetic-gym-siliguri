              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-[#5d0000] font-bold text-lg">
                    <a href="tel:086701 10643">086701 10643</a>
                  </p>
...
2nd Mile, Sevoke Road, Ramkrishna Sarani, Jyotinagar, Ward no 41, Siliguri, India
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-lg font-bold text-[#5d0000]">
                    <a href="mailto:bhupenchhetri288@gmail.com">bhupenchhetri288@gmail.com</a>
                  </p>
              ...
              <div className="flex space-x-4 mt-4 text-gray-500 text-2xl">
                <a href="https://www.instagram.com/aestheticgym2022/" className="hover:text-yellow-500"><FaInstagram /></a>
                <a href="https://www.facebook.com/p/Aesthetic-Gym-100076324580760/" className="hover:text-[#2f2484]"><FaFacebook /></a>
