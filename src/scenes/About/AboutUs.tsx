        ...
        <div className="w-full max-w-7xl">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold mb-6 text-yellow-400 drop-shadow-lg">
              About Aesthetic Gym Fitness Gym
            </h1>
            <p className="text-lg mb-8 max-w-2xl mx-auto text-gray-300">
              Welcome to Aesthetic Gym Fitness Gym – The Premier Fitness Destination in Alipurduar! We offer a 
          ...
          >
            ...
            <div className="space-y-4 text-lg text-gray-300">
              <p><MapPin className="inline mr-2" /> 2nd Mile, Sevoke Road, Ramkrishna Sarani, Jyotinagar, Ward no 41, Siliguri, India</p>
              <p><Phone className="inline mr-2" />  086701 10643</p>
              <p><Mail className="inline mr-2" /> bhupenchhetri288@gmail.com</p>
            </div>
          </motion.div>
